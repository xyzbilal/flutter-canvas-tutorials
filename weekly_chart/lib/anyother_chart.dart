...
//! https://github.com/MSzalek-Mobile/weight_tracker/blob/v0.6/lib/widgets/weight_list_item.dart
//! https://fidev.io/line-chart-flutter/
...
import 'package:weekly_chart/tuple.dart';
...
class ProgressChart extends StatelessWidget {
  ...
  double _calculateWeightOnBeginningDate(WeightEntry lastEntryBeforeBeginning,
    ...
    int differenceInDaysFromBeginning =
        beginningDate.difference(lastEntryDateTime)
            .inDays;
...
class ChartPainter extends CustomPainter {
  ...
  ui.Paragraph _buildParagraphForBottomLabel(int daysFromStart) {
    ui.ParagraphBuilder builder =  ui.ParagraphBuilder(
      ...
      ..addText( DateFormat('d MMM').format( DateTime.now().subtract(
           Duration(days: ProgressChart.NUMBER_OF_DAYS - daysFromStart))));
...
DateTime _getStartDateOfChart() {
  ...
  DateTime beginningOfChart = now.subtract( Duration(
